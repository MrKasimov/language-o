...
import org.innopolis.lsd.exception.FieldNotFoundException;
import org.innopolis.lsd.exception.LocalVariableNotFoundException;
import org.innopolis.lsd.exception.MethodSignatureNotFoundException;
import org.innopolis.lsd.exception.MethodWithNameAlreadyDefinedException;
...
//            return new ClassPathScope().getConstructorSignature(className, argumentsTypes)
            return new ClassPathScope().getConstructorSignature("this", argumentsTypes)
